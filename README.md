<p align="center">
  <img src="assets/profile-header.png" width="320" alt="GermanSed profile banner">
</p>

<p align="center">
  <a href="https://github.com/German4341374?tab=repositories"><img alt="Open to work" src="https://img.shields.io/badge/STATUS-OPEN_TO_WORK-22c55e?style=for-the-badge"></a>
  <img alt="Backend development" src="https://img.shields.io/badge/FOCUS-BACKEND-2563eb?style=for-the-badge">
  <img alt="DevOps engineering" src="https://img.shields.io/badge/FOCUS-DEVOPS-7c3aed?style=for-the-badge">
</p>
...
- Start with a small, explicit architecture and document its trade-offs.
- Treat tests, health checks, migrations, observability, and rollback as product features.
- Prefer least privilege, pinned dependencies, reproducible local environments, and automated security checks.
- Write runbooks for failure modes instead of assuming the happy path.
- Keep examples local and free to run whenever a cloud account is not essential.
